 ...
 * -----------------------------------------------------------------------
 * 10/06/2021
 * [m] Alterações para funcionar no CodeIgniter 4
 * 02/02/2010
...
class Inflector {
	 ...
	 *        	
	 * @return bool
	 * @version 1.0 13/02/2013 Initial
	 *         
	 */
	 ...
	 *        	Terminação da palavra no singular
	 * @param string $pluralSuffix
	 *        	Terminação da palavra no plural
	 *        	
	 * @return bool
	 * @version 1.0 13/02/2013 Initial
	 *         
	 ...
	 *
	 * @param string $word
	 *        	A palavra que deseja ser passada para o plural
	 *        	
	 * @return string
	 * @version 1.0 Initial
	 ...
	 *
	 * @param string $word
	 *        	A palavra que deseja ser passada para o singular
	 *        	
	 * @return string
	 * @version 1.0 Initial
	 *          1.1 15/04/2010 Substituição do str_replace() pelo preg_replace()
