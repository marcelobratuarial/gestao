...
class Contato extends BaseController
{
	...
	public function remover($code) {
		$contato = new ContatoModel();

		$contato->where('code', $code)
				->delete();
		$contato->purgeDeleted();
		setSwal('success', 'Tudo certo!', 'Contato removido com sucesso.');
	...
	public function save()
	{
		...
		$data['codeEmpresa'] = $data['codeEmpresa'];
		...
		if ($action == 'insert') :
			$contato->insert($data);
			addHistorico('empresa', $data['codeEmpresa'], $data['codeStatus'], 'Contato adicionado: '. $data["nome"]);
			setSwal('success', 'Tudo certo!', 'Contato adicionado com sucesso.');
