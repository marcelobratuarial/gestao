        ...
        <form method="post" action="<?= base_url("$path/save/tabela"); ?>">
            <table>
                <thead>
                    ...
                    <th>
                        <label for="inputName" class="form-label">Adesão</label>
                    </th>
                    <th>
                ...
                <tbody>
                    <?php foreach ($tabela as $t) : ?>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="linha[<?= $t->id; ?>][adesao]" class="form-control" id="inputName" value="<?= $t->adesao; ?>">
                            </td>
                            <td>
    ...
    <div class="card-body p-5">
        ...
        <form method="post" action="<?= base_url("$path/save/tabela"); ?>">
            ...
            <div class="row g-3 pt-3">
                ...
                <div class="col-md-2">
                    <input type="text" name="adesao" class="form-control" id="inputAdesao" value="">
                </div>
            </div>
