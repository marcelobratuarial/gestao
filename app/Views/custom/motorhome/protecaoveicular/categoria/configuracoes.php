    ...
    <div class="card-body p-5">
        ...
        <form method="post" action="<?= base_url("$path/save/configuracoes"); ?>">
            <div class="row g-3">
                ...
                <div class="col-md-2">
                    <label for="selectImplemento" class="form-label">Implemento</label>
                    <select type="checkbox" name="implemento" class="form-select" id="selectImplemento">
                        <option value="0" <?= $categoria->implemento == 0 ? 'selected' : null; ?>>Não</option>
                        <option value="1" <?= $categoria->implemento == 1 ? 'selected' : null; ?>>Sim</option>
                    </select>
                </div>
                <div class="col-md-12">
