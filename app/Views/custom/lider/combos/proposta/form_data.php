            ...
            <div id="fipe" class="">
                <div class="row my-3">
                    ...
                    <div class="col-6">
                        ...
                        <select class="single-select form-select radius-square" name="veiculo_tipo" required>
                ...
                <div class="row my-3">
                    <div class="col-3">
                        ...
                        <select class="single-select form-select radius-square" name="veiculo_marca" required>
                    ...
                    <div class="col-6">
                        ...
                        <select class="single-select form-select radius-square" name="veiculo_modelo" required>
                    ...
                    <div class="col-3">
                        ...
                        <select class="single-select form-select radius-square" name="veiculo_ano" data-path="<?= $path ?>" required>
